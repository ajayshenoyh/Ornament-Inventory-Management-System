 ...
 position: absolute;
   ...
   /* #lend {
    ...
    visibility: hidden;
	 ...
	 jQuery(function(){
		 $("#fid").autocomplete("llistfest.jsp");
...
<div class="container">
 ...
 <br>
 <input class="buttom" name="festb" id="festb" tabindex="5" value="Festival Lending" type="button" onclick="fest()">
 <label for="name" id="fid1"></label>
 <br>
 </form> 
    			<input id="fid" name="fid" placeholder="Festival Name" required="" tabindex="1" type="text">
    			 <button name="fes" id="fes" onclick="fes()">Search</button>
