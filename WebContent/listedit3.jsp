...
if ((rs.next())) {
	...
	<input class="buttom" name="lend" id="lend" value="Delete this item" tabindex="5" type="button" onclick="loadContent1('hi')"  > 
		<%
}
	else
	{
		%> <font size="6"><% out.println("<p><u>STATUS:UNAVAILABLE </u></p>");%>  </font> <a href="delete22.jsp">TRY AGAIN</a><% 
