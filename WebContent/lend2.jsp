...
if ((rs.next())) {
	if(rs.getString(9).equals(pass))
	{
		...
		<input class="buttom" name="lend" id="lend" value="Lend this item" tabindex="5" type="button" onclick="loadContent1('hi')"  >
		<%
}
	else
	{
		%> <font size="6"><% out.println("<p><u>STATUS:UNAVAILABLE </u></p>");%>  </font> <a href="lend22.jsp">TRY AGAIN</a><% 
