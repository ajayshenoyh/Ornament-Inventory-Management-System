...
ResultSet rs2=null;
stmt.executeUpdate("delete from lend where lid='"+ id +"'");
String status="a";
PreparedStatement pre = con.prepareStatement("insert into itemmissing(id,name,damage,pearl1,pearl2,pearl3,pearl4,pearl5,pearl6,pearl7,pearl8,pearl9,weight) values(?,?,?,?,?,?,?,?,?,?,?,?,?)");
pre.setString(1,id);
pre.setString(2,name);
...
int s=pre.executeUpdate();
if(s>0) {
out.println("Added to Missing item list!");
}
...
String texarea1;
texarea1="Item Id : "+id+ "      Item Name : "+name+ "       has some missing items ";
