...
<%!public String id,pass="na",lid,nam; %>
<%
...
if ((rs.next())) {
	if(rs.getString(9).equals(pass))
	{
		...
		<input class="buttom" name="lend" id="lend" value="Returned Successfully" tabindex="5" type="button" onclick="loadContent1('hi')"  >
		<input class="buttom" name="l1" id="l1" value="Missing Some pearls" tabindex="5" type="button" onclick="loadContent7('hi')"  >
		<!--  <input class="buttom" name="l2" id="l2" value="Completely Damaged" tabindex="5" type="button" onclick="loadContent6('hi')"  >
		-->
		<%
